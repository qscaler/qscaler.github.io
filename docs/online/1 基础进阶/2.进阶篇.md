...
![](https://s.poetries.work/images/20210516162034.png) ![](https://s.poetries.work/images/20210516162330.png)

> 自动执行的情况 会输出 listener1 listener2 task1 task2

![](https://s.poetries.work/images/20210516162704.png) ![](https://s.poetries.work/images/20210516163038.png)
...
[内存泄露排查方法<span><span class="sr-only">(opens new window)</span></span>](https://juejin.cn/post/6947841638118998029?utm_source=gold_browser_extension)
...
![](https://s.poetries.work/gitee/2020/09/7.png) ![](https://s.poetries.work/gitee/2020/09/8.png)
...
*   `dns-prefetch`。当 `link` 标签的 `rel` 属性值为“dns-prefetch”时，`浏览器会对某个域名预先进行 DNS 解析并缓存`。这样，当浏览器在请求同域名资源的时候，能省去从域名查询 IP 的过程，从而`减少时间损耗`。下图是淘宝网设置的 DNS 预解析 ![](https://s.poetries.work/images/20210421163848.png)
...
> 了解更多关于重绘和重排的样式属性，可以参看这个网址：[https://csstriggers.com/<span><span class="sr-only">(opens new window)</span></span>](https://csstriggers.com/)。
...
> 当然可以设置的属性远不止这些，你可以通过查阅 [文档<span><span class="sr-only">(opens new window)</span></span>](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy) 的方式来学习，这里就不过多赘述其他的属性了。
...
[框架通识<span><span class="sr-only">(opens new window)</span></span>](https://interview.poetries.top/excellent-docs/16-%E6%A1%86%E6%9E%B6%E9%80%9A%E8%AF%86.html)
...
<td style="text-align: left;">❌`setup`(替代)</td>
...
<td style="text-align: left;">`nUpdated`</td>
...
[真正理解虚拟DOM<span><span class="sr-only">(opens new window)</span></span>](http://interview.poetries.top/principle-docs/react/15-%E7%9C%9F%E6%AD%A3%E7%90%86%E8%A7%A3%E8%99%9A%E6%8B%9FDOM.html)
...
**在线查看**：[https://projects.wojtekmaj.pl/react-lifecycle-methods-diagram<span><span class="sr-only">(opens new window)</span></span>](https://projects.wojtekmaj.pl/react-lifecycle-methods-diagram)
...
> *   [React16为什么要更改生命周期<span><span class="sr-only">(opens new window)</span></span>](https://interview.poetries.top/principle-docs/react/11-React16%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E6%9B%B4%E6%94%B9%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E4%B8%8A.html)
> *   [React16为什么要更改生命周期<span><span class="sr-only">(opens new window)</span></span>](https://interview.poetries.top/principle-docs/react/12-React16%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E6%9B%B4%E6%94%B9%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E4%B8%8B.html)
...
![](https://s.poetries.work/images/20210409153900.png) ![](https://s.poetries.work/images/20210409153914.png) ![](https://s.poetries.work/images/20210409153926.png) ![](https://s.poetries.work/images/20210409153942.png) ![](https://s.poetries.work/images/20210409154004.png) ![](https://s.poetries.work/images/20210409154015.png)
...
![](https://s.poetries.work/images/20210409154118.png) ![](https://s.poetries.work/images/20210409154127.png) ![](https://s.poetries.work/images/20210409154136.png)
...
![](https://s.poetries.work/images/20210407215708.png) ![](https://s.poetries.work/images/20210407215721.png)
...
[浅析中间件<span><span class="sr-only">(opens new window)</span></span>](http://interview.poetries.top/principle-docs/react/08-%E6%B5%85%E6%9E%90%E4%B8%AD%E9%97%B4%E4%BB%B6.html)
...
[React router原理分析<span><span class="sr-only">(opens new window)</span></span>](http://interview.poetries.top/principle-docs/react/01-React-router%E5%8E%9F%E7%90%86.html)
...
![](https://s.poetries.work/images/20210409165629.png) ![](https://s.poetries.work/images/20210409165723.png)
...
![](https://s.poetries.work/images/20210421175226.png)
...
![](https://s.poetries.work/images/20210503202857.png)
...
![](https://s.poetries.work/images/20210503203408.png) ![](https://s.poetries.work/images/20210507090818.png)
...
![](https://s.poetries.work/images/20210503203917.png)

![](https://s.poetries.work/images/20210503203927.png)

###  5 HTTP之URL

![](https://s.poetries.work/images/20210503204105.png)
...
![img](https://s.poetries.work/gitee/2019/12/15.png)
...
![img](https://s.poetries.work/gitee/2019/12/16.png)
...
![img](https://s.poetries.work/gitee/2019/12/17.png)
...
![](https://s.poetries.work/images/20210409105003.png)
...
![](https://s.poetries.work/images/20210409105413.png)
...
![](https://s.poetries.work/images/20210409105827.png)
...
![](https://s.poetries.work/images/20210409105910.png)
...
![](https://s.poetries.work/images/20210409110016.png)
...
![](https://s.poetries.work/images/20210503210054.png)

**我们通过一张图来看看它的查询过程吧**👇

![](https://s.poetries.work/images/20210409102754.png)

这张图很生动的展示了DNS在本地DNS服务器是如何查询的，**一般向本地DNS服务器发送请求是递归查询的**

本地 DNS 服务器向其他域名服务器请求的过程是迭代查询的过程👇

![](https://s.poetries.work/images/20210409102812.png)
...
![](https://s.poetries.work/images/20210409103238.png)
...
![](https://s.poetries.work/images/20210426214118.png)
...
![](https://s.poetries.work/images/20210503205601.png)
...
![](https://s.poetries.work/images/20210504140502.png)
...
![](https://s.poetries.work/uploads/2023/02/59f605e360314d03.png)
...
![](https://s.poetries.work/images/20210414092128.png)
...
![](https://s.poetries.work/images/20210414092111.png)
